...
%   Intelligent Reflecting Surface vs. Decode-and-Forward: How Large Surfaces 
%   Are Needed to Beat Relaying?, IEEE Wireless Communications Letters
%
close all;
clear;
clc;
...
%
beta_3GPP_LOS  = db2pow(antennaGainTdBi + antennaGainRdBi - 28.0 - 20 * log10(fc) - 22.0 * log10(d));
